...
**Investimentos (Não Contabilizar como Gasto/Receita):**
- Investimento - Aplicação: APLICACAO, APORTE, COMPRA ATIVO, CDB, LCI, LCA, TESOURO, POUPANCA (saída)
- Investimento - Resgate: RESGATE, RETIRADA, VENDA ATIVO, CDB, LCI, LCA, TESOURO, POUPANCA (entrada)
- Investimento - Dividendos: DIVIDENDOS, JCP, PROVENTOS
- Investimento - Rendimento: RENDIMENTO, JUROS

**Corretoras:**
- Corretora - [Nome]: CORRETORA, XP, BTG, RICO, NUBANK INVEST, INTER INVEST
...
APLICACAO|APORTE|COMPRA.*ATIVO|CDB|LCI|LCA|TESOURO|POUPANCA
RESGATE|RETIRADA|VENDA.*ATIVO
DIVIDENDOS|JCP|PROVENTOS|RENDIMENTO
CORRETORA|XP|BTG|RICO|CLEAR|NU.*INVEST|INTER.*INVEST
...
Prioridade 6: FALLBACK
  ...
  → Se confiança < 30%, pedir feedback do usuário (em versão futura)
\`\`\`
