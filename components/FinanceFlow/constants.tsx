...
export const MOCK_INVESTMENTS: InvestmentAsset[] = [
  { id: 'i1', name: 'Tesouro Selic 2029', type: 'FIXED_INCOME', value: 45000, change24h: 0.05, allocation: 45, investedAmount: 40000, entryDate: '2024-01-15', status: 'ACTIVE' },
  { id: 'i2', name: 'Bitcoin', symbol: 'BTC', type: 'CRYPTO', value: 12500, change24h: 3.2, allocation: 12.5, investedAmount: 8000, entryDate: '2023-11-20', status: 'ACTIVE' },
  { id: 'i3', name: 'CDB Banco Inter', type: 'FIXED_INCOME', value: 25000, change24h: 0.1, allocation: 25, investedAmount: 22000, entryDate: '2024-03-10', status: 'ACTIVE' },
  { id: 'i4', name: 'Itaú Unibanco', symbol: 'ITUB4', type: 'STOCK', value: 8500, change24h: -1.2, allocation: 8.5, investedAmount: 9000, entryDate: '2024-05-05', status: 'ACTIVE' },
  { id: 'i5', name: 'HGLG11', type: 'REIT', value: 9000, change24h: 0.45, allocation: 9, investedAmount: 8500, entryDate: '2024-02-28', status: 'ACTIVE' },
];
